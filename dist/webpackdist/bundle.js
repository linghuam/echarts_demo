...
var _popover = __webpack_require__(333);

var _tagLayout = __webpack_require__(334);

var _eqpLayout = __webpack_require__(338);
...
$(function () {
    window.dialogPopover = new _popover.Dialog();
});

$(function () {
    var taglayoutInstance = new _tagLayout.TagLayout('tag_container');
    var eqplayoutInstance = new _eqpLayout.EquipMentLayout('eqp_container');
...
exports.TagLayout = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _tagGraph = __webpack_require__(335);

var _tagSingle = __webpack_require__(336);

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var TagLayout = exports.TagLayout = function () {
  function TagLayout(containerClass) {
    _classCallCheck(this, TagLayout);

    this._contanier = $('.' + containerClass);
    this._tagGraph = new _tagGraph.TagGraph();
    this._tagSingle = new _tagSingle.TagSingle('tag_single_container');
    this._initEvt();
  }
...
exports.TagGraph = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _projUtil = __webpack_require__(49);

function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; }

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var TagGraph = exports.TagGraph = function () {
  function TagGraph() {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _projUtil.Util.readFile('data/全部标签统计.csv');

              case 2:
                this._allData = _context.sent;
                _context.next = 5;
                return _projUtil.Util.readFile('data/故障原因标签统计.csv');

              case 5:
                this._gzData = _context.sent;
                _context.next = 8;
                return _projUtil.Util.readFile('data/器件原因标签统计.csv');

              case 8:
                this._qjData = _context.sent;
                _context.next = 11;
                return _projUtil.Util.readFile('data/行为原因标签统计.csv');

              case 11:
                this._xwData = _context.sent;
                _context.next = 14;
                return _projUtil.Util.readFile('data/TOP5折线图 - 日期.csv');
        ...
        xAxis: {
          ...
          axisLabel: {
            ...
            formatter: function formatter(value) {
              return _projUtil.Util.getTimeStrFromUnix2(value);
            }
          },
          splitLine: {
            show: false
...
exports.TagSingle = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _tagSingleGraph = __webpack_require__(337);

var _projUtil = __webpack_require__(49);

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var TagSingle = exports.TagSingle = function () {
    function TagSingle(containerClass) {
        _classCallCheck(this, TagSingle);
        ...
        this._singleGraph = new _tagSingleGraph.TagSingleGraph('tag_single_relationchart');
    }

    _createClass(TagSingle, [{
        key: 'start',
        value: function start(tagname) {
            this._contanier.css('display', 'block');
        ...
        value: function _initEvt() {
            ...
            this._dateSilderObj.bind("valuesChanged", function (e, data) {
                ...
                self._singleGraph.updateGraph(_projUtil.Util.getCusUnixTime(stime + ' 00:00:00'), _projUtil.Util.getCusUnixTime(etime + ' 00:00:00'));
        ...
        key: '_updateAllDocTable',
        value: function _updateAllDocTable(tableId) {
            var self = this;
...
exports.TagSingleGraph = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _projConfig = __webpack_require__(126);
...
var TagSingleGraph = exports.TagSingleGraph = function () {
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return _projUtil.Util.readFile('data/标签关联点-时间戳.csv');

                            case 2:
                                this._nodesData = _context.sent;
                                _context.next = 5;
                                return _projUtil.Util.readFile('data/标签关联边-时间戳-无向.csv');

                            case 5:
                                this._linkData = _context.sent;
                                _context.next = 8;
                                return _projUtil.Util.readFile('data/标签关联文章列表.csv');

                            case 8:
                                this._tagDocData = _context.sent;
                                _context.next = 11;
                                return _projUtil.Util.readFile('data/文章列表.csv');

                            case 11:
                                this._docData = _context.sent;
                                _context.next = 14;
                                return _projUtil.Util.readFile('data/标签关联最大值最小值-时间戳.csv');
            ...
            for (var i = 0, len = select_nodes.length; i < len; i++) {
                ...
                if (j === lenj) {
                    nodes.push({
                        ...
                        category: _projConfig.Config.categories.indexOf(n.p_tag_type),
                        name: n.p_tag_name,
                        value: 1
                    });
                }
...
exports.EquipMentLayout = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _projUtil = __webpack_require__(49);

var _eqpGraph = __webpack_require__(339);

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var EquipMentLayout = exports.EquipMentLayout = function () {
    function EquipMentLayout(containerClass) {
        _classCallCheck(this, EquipMentLayout);

        this._contanier = $('.' + containerClass);
        this._eqpGraph = new _eqpGraph.EqpGraph();
        this._months = ["1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10月", "11月", "12月"];
    }
    ...
    _createClass(EquipMentLayout, [{
        ...
        value: function _updateTimeSlider(eqpName) {
            ...
            this._dateSilderObj.bind("valuesChanged", function (e, data) {
                ...
                var stime = val.min.getFullYear() + "-" + (val.min.getMonth() + 1) + "-" + val.min.getDate();
                var etime = val.max.getFullYear() + "-" + (val.max.getMonth() + 1) + "-" + val.max.getDate();
                self._eqpGraph.updateLinkChart('eqp_relation_chart', eqpName, _projUtil.Util.getCusUnixTime(stime + ' 00:00:00'), _projUtil.Util.getCusUnixTime(etime + ' 00:00:00'));
                // console.log("起止时间：" + stime + " 至 " + etime);
            });
...
var EqpGraph = exports.EqpGraph = function () {
    function EqpGraph() {
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return _projUtil.Util.readFile('data/装备列表.csv');

                            case 2:
                                this._eqpListData = _context.sent;
                                _context.next = 5;
                                return _projUtil.Util.readFile('data/装备关联点-时间戳.csv');

                            case 5:
                                this._nodesData = _context.sent;
                                _context.next = 8;
                                return _projUtil.Util.readFile('data/装备关联边-时间戳-无向.csv');

                            case 8:
                                this._linkData = _context.sent;
                                _context.next = 11;
                                return _projUtil.Util.readFile('data/装备关联文章列表.csv');
                            ...
                            case 14:
                                this._docData = _context.sent;
                                _context.next = 17;
                                return _projUtil.Util.readFile('data/装备关联最大值最小值-时间戳.csv');

                            case 17:
                                this._timeData = _context.sent;
                                _context.next = 20;
                                return _projUtil.Util.readFile('data/装备雷达-总.csv');

                            case 20:
                                this._radarData = _context.sent;
                                _context.next = 23;
                                return _projUtil.Util.readFile('data/装备故障地点-经纬度.csv');

                            case 23:
                                this._mapData = _context.sent;
                                _context.next = 26;
                                return _projUtil.Util.getJson('data/china.json');

                            case 26:
                                this._chinajson = _context.sent;
